...
#ifndef router_5fbridge_2eproto_2epb_2eh
#define router_5fbridge_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:router_bridge.RouterPacket) */ {
 public:
  ...
  void operator delete(RouterPacket* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(RouterPacket));
  }
#endif
  ...
  RouterPacket* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:router_bridge.InterfaceUpdate) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(InterfaceUpdate* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(InterfaceUpdate));
  }
#endif
  ...
  InterfaceUpdate* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // router_5fbridge_2eproto_2epb_2eh
